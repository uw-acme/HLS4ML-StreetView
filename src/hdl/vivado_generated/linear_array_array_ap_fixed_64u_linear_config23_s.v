...
module linear_array_array_ap_fixed_64u_linear_config23_s (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((io_acc_block_signal_op198 == 1'b0) | (io_acc_block_signal_op133 == 1'b0) | (real_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (*) begin
    if ((~((io_acc_block_signal_op198 == 1'b0) | (io_acc_block_signal_op133 == 1'b0) | (real_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    ap_block_state1 = ((io_acc_block_signal_op198 == 1'b0) | (io_acc_block_signal_op133 == 1'b0) | (real_start == 1'b0) | (ap_done_reg == 1'b1));
end
...
assign res_V_data_32_V_din = data_V_data_32_V_dout;

assign res_V_data_33_V_din = data_V_data_33_V_dout;

assign res_V_data_34_V_din = data_V_data_34_V_dout;

assign res_V_data_35_V_din = data_V_data_35_V_dout;

assign res_V_data_36_V_din = data_V_data_36_V_dout;

assign res_V_data_37_V_din = data_V_data_37_V_dout;

assign res_V_data_38_V_din = data_V_data_38_V_dout;

assign res_V_data_39_V_din = data_V_data_39_V_dout;

assign res_V_data_3_V_din = data_V_data_3_V_dout;

assign res_V_data_40_V_din = data_V_data_40_V_dout;

assign res_V_data_41_V_din = data_V_data_41_V_dout;

assign res_V_data_42_V_din = data_V_data_42_V_dout;

assign res_V_data_43_V_din = data_V_data_43_V_dout;

assign res_V_data_44_V_din = data_V_data_44_V_dout;

assign res_V_data_45_V_din = data_V_data_45_V_dout;

assign res_V_data_46_V_din = data_V_data_46_V_dout;

assign res_V_data_47_V_din = data_V_data_47_V_dout;

assign res_V_data_48_V_din = data_V_data_48_V_dout;

assign res_V_data_49_V_din = data_V_data_49_V_dout;

assign res_V_data_4_V_din = data_V_data_4_V_dout;

assign res_V_data_50_V_din = data_V_data_50_V_dout;

assign res_V_data_51_V_din = data_V_data_51_V_dout;

assign res_V_data_52_V_din = data_V_data_52_V_dout;

assign res_V_data_53_V_din = data_V_data_53_V_dout;

assign res_V_data_54_V_din = data_V_data_54_V_dout;

assign res_V_data_55_V_din = data_V_data_55_V_dout;

assign res_V_data_56_V_din = data_V_data_56_V_dout;

assign res_V_data_57_V_din = data_V_data_57_V_dout;

assign res_V_data_58_V_din = data_V_data_58_V_dout;

assign res_V_data_59_V_din = data_V_data_59_V_dout;

assign res_V_data_5_V_din = data_V_data_5_V_dout;

assign res_V_data_60_V_din = data_V_data_60_V_dout;

assign res_V_data_61_V_din = data_V_data_61_V_dout;

assign res_V_data_62_V_din = data_V_data_62_V_dout;

assign res_V_data_63_V_din = data_V_data_63_V_dout;
...
endmodule //linear_array_array_ap_fixed_64u_linear_config23_s
