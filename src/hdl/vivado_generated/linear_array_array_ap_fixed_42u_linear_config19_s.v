...
module linear_array_array_ap_fixed_42u_linear_config19_s (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((real_start == 1'b0) | (io_acc_block_signal_op132 == 1'b0) | (io_acc_block_signal_op89 == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (*) begin
    if ((~((real_start == 1'b0) | (io_acc_block_signal_op132 == 1'b0) | (io_acc_block_signal_op89 == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
endmodule //linear_array_array_ap_fixed_42u_linear_config19_s
